...
#########################################################
print(f' {headers[0].title():10s} {headers[1].title():11s} {headers[2].title():10s} {headers[3].title():9s}')
print('---------- ---------- ---------- ----------')


for linea in lista_informe:
    print(f'{linea[0]:10s} {(linea[1]):>7s} {linea[2]:>11s} {round(linea[3], 2):10.2f}')