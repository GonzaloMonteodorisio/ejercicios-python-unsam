...
# 4. ¿Cuántas operaciones hace como máximo propagar_a_derecha en una lista de largo n? - n-1 operaciones
# 5. Sabiendo que invertir una lista ([::-1]) requiere una cantidad lineal de operaciones en la longitud de la lista ¿Cuántas operaciones hace como máximo propagar en una lista de largo n? 2(n-1) = 2n - 2
